...
export const practiceData: PracticeModel[] = [
  ...
  },
  {
    ...
    We can look back and reflect on how God has been faithful to us in our petitions.  How do I get started?<br>
    Find a journal and go for it!  Here’s an acronym that can help guide your prayers<br>
    Praise God<br>
    Repent of Sin<br>
  ...
  },
  {
    ...
    Sometimes it is hard to be happy with our place in life.  “If I had a little more money I would be happy.” “If my job was different I would be happy.” “When I have accomplished ____, THEN my life will be complete.” How can we be content with our life, right now?<br>
    Gratitude leads us to joy and contentment!</p>`,
    "how": `<p>What are some ways that we can have the “Joy of the Lord” in our hearts all the time?
      <ul>
        <li>Give thanks to God in prayer.</li>
        <li>Keep a gratitude journal.</li>
        <li>Keep a jar in a visible place in your home and write what you are thankful for and place in the jar, EVERY DAY!</li>
        <li>Find ways to serve others.</li>
        <li>Keep your eyes focused on Jesus instead of comparing yourself to others.</li>
        <li>Share life in community, eat together, share how God has been faithful to you.</li>
      </ul>
    </p>
  ...
  },
  {
    ...
    "how": `<p>There are several ways that you can connect with God through music, all week long!
      <ul>
        <li>Listen to uplifting music in the car.</li>
        <li>Develop a Spotify playlist - Check out “Journey Worship” for some familiar songs.</li>
        <li>Want something more random?  Pick a “station” on Pandora. Here’s a few ideas: Rend Collective Experiment, Lauren Daigle, Hymns on Piano, Bethel Music, David Crowder, Matt Maher, Gospel, Praise & Worship, Hymns 4 Worship.</li>
        <li>Share songs & hymns that connect to you, with others.</li>
        <li>Use the words of music to engage your kids in spiritual discussions.</li>
  ...
  },
  {
    ...
    The way the fallen leaves and logs break down to provide food for plants around; often with help from insects that we may think undesirable.<br>
    Shelter that is provided for God’s creatures.<br>
    Tiny flowers and elegant leaves that one has to look closely to see.<br>
    The beauty of the sunlight reflecting off the dew, or filtering through the trees.<br>
    These observations help us recognize the work of an infinitely intelligent God who is not only creative, but strategic;   a redemptive God who can take what seems negative; fallen limbs, trees, and leaves, and turn it into something that provides life, shelter, and nourishment;   a God who loves us immensely and provides beauty generously.  Some of that beauty is subtle so we are rewarded when we slow down enough to appreciate its intricacy.<br>
    What is the Holy Spirit speaking to you?<br>
    What is God redeeming in your life?<br>
    What quiet beauty has God put in your life that you may be missing?<br>
  ...
  },
  {
    ...
    "how": `<p>4 Keys to Hearing God's Voice.
      <ol>
        <li>Stillness.  Get alone and quiet your soul.  Play soft music, imagine yourself in nature, sing a love song to Jesus; whatever works for you. <i>Psalm 46:10a</i></li>
        <li>Vision.  Fix your eyes on Jesus.  Picturing Him in a familiar Bible scene may help you "see" Him. <i>Hebrews 12:2</i></li>
        <li>Tune to the flow of Holy Spirit. <i>John 7:37-39</i>.  See what He wants to tell you and show you.</li>
